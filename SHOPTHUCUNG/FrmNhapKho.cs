...
namespace SHOPTHUCUNG
{
    public partial class FrmNhapKho : DevExpress.XtraEditors.XtraForm
    {
        ...
        Bitmap imgDefault = Properties.Resources.hình;
        ...
        private void ChartSanPhamHetHang()
        {
            ...
            SqlDataAdapter adapt = new SqlDataAdapter("select TenSP,SoLuongTon from SanPham where SoLuongTon <= 10", con);
            adapt.Fill(ds);
